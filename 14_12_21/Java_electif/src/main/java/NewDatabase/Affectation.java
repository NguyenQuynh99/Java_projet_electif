...
public class Affectation {
    ...
    public String[][] listAffectation(){
        String[][] listAff = new String[100][3];
        ...
        for (int i=0; i<this.etudiants.size(); i++){
            listAff[i][0]=listEtudiant[i];
            listAff[i][1]=groupe1[i];
            listAff[i][2]=groupe2[i];
        }
        return listAff;
    }
    ...
    public static void main(String[] args){
        ...
        Affectation affectation = new Affectation();
        affectation.createColonneEtudiant();
        String[] groupe1 = new String[100];
        String[] groupe2 = new String[100];

        String[][] listAff = affectation.listAffectation();
        
        for (int i=0; i<100; i++){
            groupe1[i] = listAff[i][1];
            groupe2[i] = listAff[i][2];
        }
        
        System.out.println(affectation.toStringDetail(groupe1, groupe2));
        System.out.println(listAff[0][0]+ " " + listAff[0][1] + " " + listAff[0][2]);
        }
    }
